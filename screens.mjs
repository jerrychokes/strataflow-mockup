...
export const JOBS = [
  { id: 'j0', n: 'J0', title: 'Arrive, and find out what needs you', who: 'U1 · U2 · U4 · U5',
    ...
    screens: [
      { id: 'home', label: 'Work queue', body: workQueue, state: 'not built', isNew: true },
      { id: 'search', label: 'Search', body: globalSearch, state: 'not built', isNew: true },
      { id: 'projects', label: 'Projects', body: projectList, state: 'engine-only', isNew: true },
      { id: 'project-home', label: 'Project home', body: projectHome, state: 'shipped', isNew: true },
    ] },
  { id: 'j1', n: 'J1', title: 'Get the data in, and know it landed', who: 'U1 · U5',
    ...
    screens: [
      { id: 'locations', label: 'Location register', body: locationRegistry, state: 'shipped', isNew: true },
      { id: 'location', label: 'Location detail', body: locationDetail, state: 'not built' },
      { id: 'facility', label: 'Facility and areas', body: facilityScreen, state: 'engine-only', isNew: true },
      { id: 'events', label: 'Sampling events', body: samplingEvents, state: 'shipped', isNew: true },
      { id: 'imports', label: 'Import runs', body: importRuns, state: 'shipped' },
      { id: 'import-review', label: 'Exception review', body: importReview, state: 'shipped' },
      { id: 'import-commit', label: 'Commit and reversal', body: importCommit, state: 'shipped' },
      { id: 'quarantine', label: 'Held rows', body: quarantine, state: 'engine-only', isNew: true },
      { id: 'purge', label: 'Purge and stabilisation', body: purgeLog, state: 'not built', isNew: true },
      { id: 'receipt', label: 'Receipt and custody', body: sampleReceipt, state: 'not built', isNew: true },
      { id: 'certificate', label: 'Certificate and supersession', body: certificate, state: 'engine-only' },
      { id: 'migration', label: 'Legacy reconciliation', body: migration, state: 'engine-only' },
      { id: 'field-capture', label: 'Field capture', body: fieldCapture, state: 'proposed' },
    ] },
  { id: 'j2', n: 'J2', title: 'Know the data is right', who: 'U1 · U2',
    ...
    screens: [
      { id: 'qc', label: 'QA/QC workspace', body: qcWorkspace, state: 'engine-only' },
      { id: 'batches', label: 'Laboratory batches', body: labBatches, state: 'not built', isNew: true },
      { id: 'qc-limits', label: 'Data quality objectives', body: qcLimits, state: 'not built', isNew: true },
      { id: 'dqa', label: 'Data quality assessment', body: dataQuality, state: 'not built', isNew: true },
      { id: 'consistency', label: 'Internal consistency', body: consistency, state: 'engine-only' },
      { id: 'validation', label: 'Validation state', body: validationBoard, state: 'engine-only' },
      { id: 'qualifiers', label: 'Qualifiers and lock', body: qualifiers, state: 'engine-only' },
    ] },
  { id: 'j3', n: 'J3', title: 'Know what is wrong', who: 'U2 · U3 · U4',
    ...
    screens: [
      { id: 'exceedances', label: 'Exceedance register', body: exceedances, state: 'engine-only' },
      { id: 'crosstab', label: 'Results crosstab', body: crosstab, state: 'engine-only' },
      { id: 'result-detail', label: 'Result detail', body: resultDetail, state: 'engine-only', isNew: true },
      { id: 'hardness', label: 'How this criterion was calculated', body: hardnessDerivation, state: 'not built', isNew: true },
      { id: 'indeterminate', label: 'Could not be assessed', body: indeterminateRegister, state: 'not built', isNew: true },
      { id: 'tarp', label: 'TARP state', body: tarpBoard, state: 'engine-only' },
      { id: 'alerts', label: 'Alerts', body: alerts, state: 'engine-only' },
    ] },
  { id: 'j4', n: 'J4', title: 'Understand it and explain it', who: 'U2',
    ...
    screens: [
      { id: 'hydrograph', label: 'Hydrograph', body: hydrographWorkspace, state: 'engine-only' },
      { id: 'hydrochem', label: 'Hydrogeochemistry', body: hydrochem, state: 'engine-only' },
      { id: 'statistics', label: 'Statistics and trend', body: statistics, state: 'engine-only' },
      { id: 'background', label: 'Background comparison', body: backgroundComparison, state: 'not built', isNew: true },
      { id: 'stygofauna', label: 'Subterranean fauna', body: stygofaunaScreen, state: 'not built', isNew: true },
      { id: 'map', label: 'Map and spatial', body: mapScreen, state: 'engine-only' },
      { id: 'saved-views', label: 'Saved views', body: savedViews, state: 'proposed' },
    ] },
  { id: 'j5', n: 'J5', title: 'Produce the submission', who: 'U2 · U4',
    ...
    screens: [
      { id: 'report', label: 'Report builder', body: reportBuilder, state: 'engine-only' },
      { id: 'report-figures', label: 'Figures and tables', body: reportFigures, state: 'engine-only' },
      { id: 'narrative', label: 'Interpretation', body: narrative, state: 'proposed' },
      { id: 'snapshot', label: 'Snapshot and reissue', body: snapshot, state: 'engine-only' },
      { id: 'submissions', label: 'Submission archive', body: submissionArchive, state: 'engine-only', isNew: true },
    ] },
  { id: 'j6', n: 'J6', title: 'Keep the obligations met', who: 'U4 · U1',
    ...
    screens: [
      { id: 'obligations', label: 'Obligations board', body: obligations, state: 'shipped' },
      { id: 'programme', label: 'Sampling programme', body: programme, state: 'engine-only' },
      { id: 'licence', label: 'Licence and conditions', body: licenceScreen, state: 'engine-only', isNew: true },
      { id: 'notification', label: 'Statutory notification', body: notification, state: 'engine-only' },
      { id: 'signoff', label: 'Approval and sign-off', body: signoff, state: 'engine-only' },
    ] },
  { id: 'j7', n: 'J7', title: 'Prove what was known, and when', who: 'U2 · U4',
    ...
    screens: [
      { id: 'lineage', label: 'Lineage', body: lineage, state: 'proposed' },
      { id: 'audit', label: 'Audit trail', body: auditTrail, state: 'engine-only' },
      { id: 'supersession', label: 'Supersession', body: supersession, state: 'engine-only' },
      { id: 'documents', label: 'Documents and evidence', body: documents, state: 'engine-only', isNew: true },
    ] },
  { id: 'j8', n: 'J8', title: 'Configure the instance', who: 'U5',
    ...
    screens: [
      { id: 'project-settings', label: 'Project settings', body: projectSettings, state: 'not built', isNew: true },
      { id: 'criteria', label: 'Criteria library', body: criteriaLibrary, state: 'engine-only' },
      { id: 'formats', label: 'EDD formats', body: formatDesigner, state: 'engine-only' },
      { id: 'mapping-profiles', label: 'Mapping profiles', body: mappingProfiles, state: 'engine-only', isNew: true },
      { id: 'dictionary', label: 'Analyte dictionary', body: dictionary, state: 'engine-only' },
      { id: 'units', label: 'Units and conversions', body: unitsScreen, state: 'engine-only', isNew: true },
      { id: 'roles', label: 'Access', body: roles, state: 'engine-only' },
    ] },
  { id: 'j9', n: 'J9', title: 'Keep the instance alive', who: 'U6',
    ...
    screens: [
      { id: 'instance', label: 'Instance health', body: instanceHealth, state: 'shipped (CLI)' },
      { id: 'upgrade', label: 'Upgrade and rollback', body: upgradeScreen, state: 'shipped (CLI)', isNew: true },
      { id: 'diagnostics', label: 'Backup and diagnostics', body: diagnostics, state: 'shipped (CLI)' },
      { id: 'entitlement', label: 'About this instance', body: entitlementScreen, state: 'not built', isNew: true },
    ] },
  { id: 'j10', n: 'J10', title: 'The conventions the whole product keeps', who: 'Every user',
    ...
    screens: [
      { id: 'data-states', label: 'Four states, everywhere', body: dataStates, state: 'shipped', isNew: true },
      { id: 'assistance', label: 'Keyboard and assistance', body: assistance, state: 'not built', isNew: true },
      { id: 'coverage', label: 'Coverage matrix', body: coverage, state: 'proposed', isNew: true },
    ] },
];
