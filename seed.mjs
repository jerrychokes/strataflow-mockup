...
export const QAQC = [
  ...
  { check: 'Field duplicate RPD', scope: 'MW07 / MW07-DUP', outcome: 'pass', detail: 'All 14 paired analytes within 30% RPD. Largest: sulfate at 11.4%.', action: '—' },
  { check: 'Field duplicate RPD', scope: 'MW05 / MW05-DUP', outcome: 'warn', detail: 'Zinc 21.4 and 31.6 µg/L — RPD 38.2% against a 30% limit. Both results above 5 × LOR, so the percentage test applies and this is a real disagreement rather than noise near the limit.', action: 'Qualifier J assigned — estimated' },
  { check: 'Field duplicate RPD', scope: 'Cadmium · MW05 / MW05-DUP', outcome: 'pass', detail: 'Both results below 5 × LOR, so the absolute-difference test applies rather than RPD: 0 µg/L against a 2 × LOR allowance. An RPD here would have been arithmetic on noise.', action: '—' },
  ...
  { check: 'Field blank', scope: 'FB-2026Q2-01', outcome: 'pass', detail: 'All analytes below LOR.', action: '—' },
  { check: 'Trip blank', scope: 'TB-2026Q2-01', outcome: 'pass', detail: 'All analytes below LOR.', action: '—' },
  { check: 'Rinsate blank', scope: 'RB-2026Q2-01 · bladder pump after MW05', outcome: 'warn', detail: 'Zinc 1.4 µg/L in the equipment rinsate against a 1.0 µg/L LOR. The pump was reused between MW05 and MW07, and MW07 is the other zinc exceedance this round.', action: 'MW07 zinc flagged for review — carry-over cannot be ruled out' },
...
export const EVENTS = [
  { code: '2026-Q2-GW', label: 'Quarterly groundwater', window: '1 Apr – 30 Jun 2026', collected: '12–14 May 2026', by: 'A. Nakamura', samples: 9, qc: 3, state: 'results-complete', lab: 'Pilbara Analytical Services' },
...
/** The samples inside `2026-Q2-GW`, as its detail view lists them. */
export const EVENT_SAMPLES = [
  { id: 'WDL-26Q2-001', location: 'MW01A', matrix: 'Groundwater', collected: '2026-05-12 07:55 AWST', depth: '20.4 m bgl', tests: 14, results: 14, qc: '—', state: 'evaluated' },
  { id: 'WDL-26Q2-002', location: 'MW03B', matrix: 'Groundwater', collected: '2026-05-12 10:20 AWST', depth: '48.8 m bgl', tests: 14, results: 14, qc: '—', state: 'evaluated' },
  { id: 'WDL-26Q2-003', location: 'MW05', matrix: 'Groundwater', collected: '2026-05-13 08:40 AWST', depth: '15.2 m bgl', tests: 16, results: 16, qc: '—', state: 'evaluated' },
  { id: 'WDL-26Q2-004', location: 'MW05', matrix: 'Groundwater', collected: '2026-05-13 08:40 AWST', depth: '15.2 m bgl', tests: 14, results: 14, qc: 'Blind duplicate of 003', state: 'evaluated' },
  { id: 'WDL-26Q2-005', location: 'MW07', matrix: 'Groundwater', collected: '2026-05-13 11:05 AWST', depth: '17.1 m bgl', tests: 14, results: 14, qc: '—', state: 'evaluated' },
  { id: 'WDL-26Q2-006', location: 'MW09', matrix: 'Groundwater', collected: '2026-05-14 07:30 AWST', depth: '18.6 m bgl', tests: 14, results: 13, qc: '—', state: 'results-partial' },
  { id: 'WDL-26Q2-QC1', location: '—', matrix: 'Field blank', collected: '2026-05-13 08:00 AWST', depth: '—', tests: 14, results: 14, qc: 'Field blank', state: 'evaluated' },
  { id: 'WDL-26Q2-QC2', location: '—', matrix: 'Trip blank', collected: '2026-05-12 06:00 AWST', depth: '—', tests: 14, results: 14, qc: 'Trip blank', state: 'evaluated' },
];
...
/** Custody, as a chain rather than as a PDF. */
export const CUSTODY = [
  { at: '2026-05-14 16:20 AWST', from: 'A. Nakamura — field', to: 'A. Nakamura — vehicle esky', what: '38 containers sealed, seals 4471/4472', state: 'ok' },
  { at: '2026-05-14 16:40 AWST', from: 'A. Nakamura', to: 'Pilbara Freight — consignment PF-2026-118420', what: 'Cooler handed over, signed', state: 'ok' },
  { at: '2026-05-15 09:12 AWST', from: 'Pilbara Freight', to: 'Pilbara Analytical Services — receipt', what: 'Seals verified intact, 4.2 °C, 1 container cracked', state: 'exception' },
  { at: '2026-05-15 09:40 AWST', from: 'PAS receipt', to: 'PAS laboratory — work order PAS-WO-268841', what: 'Logged, subsampled, preserved', state: 'ok' },
];
...
export const QC_LIMITS = {
  ...
  rules: [
    ...
    { check: 'Field / trip / rinsate blank', limit: '< LOR', applies: 'One field and one trip blank per event; rinsate per equipment reuse', source: 'Site DQO' },
